...
import { Layout, Menu, Breadcrumb, Button, Typography,Input ,Modal  } from 'antd';
...
class TodoInput extends Component {
 ...
 const {item, handleChange, handleSubmit, editItem, editUserTitle } = this.props;
        ...
        <div className="ant-col-24 demo-col demo-col-1">
         ...
         <div className="ant-col-24">
           ...
           <Button type="primary" onClick={this.showModal}>
            ...
            <input type="text" className="form-control text-capitalize" placeholder="Add User"
            value={item}
            ...
            <button type="submit" onClick={this.handleOk}
              className="btn  btn-block btn-info mt-4">add users</button>
            </form>
